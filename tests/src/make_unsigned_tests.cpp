...
static bool checker(void) {
	...
	// get signed type
	using type = xns::make_unsigned<T>;
	...
	// evaluate sign
	constexpr bool sign_test     = std::is_unsigned<type>::value;
...
/* unit test */
template <>
bool UT::unit_tests<"make_unsigned">(void) {
	...
	using type = xns::make_unsigned<ebool>;
