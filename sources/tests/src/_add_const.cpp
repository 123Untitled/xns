...
auto unit_tests_add_const(void) -> int {
	...
	func f[] {
		...
		//&check<xns::add_const<int*>, std::add_const_t<int*>>,
		//&check<xns::add_const<int* const>, std::add_const_t<int* const>>,
		//&check<xns::add_const<int* volatile>, std::add_const_t<int* volatile>>,
		//&check<xns::add_const<int* const volatile>, std::add_const_t<int* const volatile>>,
		//&check<xns::add_const<int[]>, std::add_const_t<int[]>>,
