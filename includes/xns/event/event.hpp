...
namespace xns {
	...
	//
	//		/* input vector type */
	//		using input_vector = void*;//xns::vector<xns::callable<void(const xns::string&)>>;
	//		//using input_vector = xns::vector<xns::callable<void(const xns::string&)>>;
	//
	//		/* event vector type */
	//		using event_vector = void*;//xns::vector<xns::callable<void(void)>>;
