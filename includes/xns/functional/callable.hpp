...
namespace xns {
	...
	class callable<R(A...)> final {
		...
		//		// construct
		//		xns::lifecycle<method_impl<C>>::construct(_base, method, instance);
		//	}
		//
		...
		//	: _base{xns::allocator<method_impl<C>>::allocate2()} {
		//		// construct
		//		xns::lifecycle<method_impl<C>>::construct(
		...
		//		// construct
		//		xns::lifecycle<function_impl>::construct(
		...
		//			return;
		//		// destroy base
		//		xns::lifecycle<base>::destroy(_base);
		//		// deallocate memory
		...
		//			return nullptr;
		//			// construct copy
		//			//xns::lifecycle<method_impl>::construct(copy, _method, _instance);
		//			// return copy
		//			//return copy;
		//		}
		//
		...
		//			// construct copy
		//			//xns::lifecycle<function_impl>::construct(copy, _function);
		//			// return copy
		//			//return copy;
		//		}
		//
